...
typedef SWIFT_ENUM(NSInteger, PLYEvent, open) {
  ...
  PLYEventSubscriptionContentUsed = 40,
};
...
typedef SWIFT_ENUM(NSInteger, PLYEventProperty, open) {
  ...
  PLYEventPropertyAudienceId = 57,
  PLYEventPropertyAbTestId = 58,
  PLYEventPropertyAbTestVariantId = 59,
  PLYEventPropertyContentId = 60,
  PLYEventPropertySessionDuration = 61,
  PLYEventPropertySessionCount = 62,
  PLYEventPropertyScreenDuration = 63,
  PLYEventPropertyScreenDisplayedAt = 64,
  PLYEventPropertyScreenDisplayedAtMs = 65,
  PLYEventPropertyAppInstalledAt = 66,
  PLYEventPropertyAppInstalledAtMs = 67,
  PLYEventPropertyPaywallrequestDurationInMs = 68,
};
