...
typedef SWIFT_ENUM(NSInteger, PLYEvent, open) {
  ...
  PLYEventDeeplinkOpened = 3,
  PLYEventPresentationViewed = 4,
  PLYEventLoginTapped = 5,
  PLYEventPurchaseFromStoreTapped = 6,
  PLYEventPurchaseTapped = 7,
  PLYEventPurchaseCancelled = 8,
  PLYEventInAppPurchasing = 9,
  PLYEventInAppPurchased = 10,
  PLYEventInAppRenewed = 11,
  PLYEventReceiptCreated = 12,
  PLYEventReceiptValidated = 13,
  PLYEventReceiptFailed = 14,
  PLYEventRestoreStarted = 15,
  PLYEventInAppRestored = 16,
  PLYEventRestoreSucceeded = 17,
  PLYEventRestoreFailed = 18,
  PLYEventInAppDeferred = 19,
  PLYEventInAppPurchaseFailed = 20,
  PLYEventLinkOpened = 21,
  PLYEventSubscriptionsListViewed = 22,
  PLYEventSubscriptionDetailsViewed = 23,
  PLYEventSubscriptionCancelTapped = 24,
  PLYEventSubscriptionPlanTapped = 25,
  PLYEventCancellationReasonPublished = 26,
};
...
@property (nonatomic, copy) NSString * _Nullable defaultPresentationVendorId;
...
+ (UIViewController * _Nonnull)productControllerFor:(NSString * _Nonnull)productVendorId with:(NSString * _Nullable)presentationVendorId completion:(void (^ _Nullable)(enum PLYProductViewControllerResult, PLYPlan * _Nullable))completion SWIFT_WARN_UNUSED_RESULT SWIFT_UNAVAILABLE_MSG("The presentations are no longer associated to a product. This will allow you to have multi-product presentations in a very near future. Call `presentationController(with:)`.");
