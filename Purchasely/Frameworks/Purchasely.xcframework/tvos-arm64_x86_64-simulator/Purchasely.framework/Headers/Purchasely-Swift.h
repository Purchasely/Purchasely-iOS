...
/// This method is particularly helpful to get the result from presentations
/// you didn’t instantiate yourself, like Promoted In-App Purchases or
/// presentations displayed by deeplinks.
...
/// The deeplink gate is normally owned by the host: deeplinks received before the
/// app signals readiness are queued and flushed once allowed. Not calling this
/// modifier leaves the override <code>nil</code> — the runtime default (queued until the host
/// calls <code>Purchasely.allowDeeplink(true)</code>) is untouched. Setting it records an
/// explicit override applied to <code>PurchaselyImplementation.shared</code> at <code>start()</code>.
