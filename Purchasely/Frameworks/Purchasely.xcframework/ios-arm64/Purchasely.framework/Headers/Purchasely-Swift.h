...
typedef SWIFT_ENUM(NSInteger, PLYEventProperty, open) {
  ...
  PLYEventPropertyContentId = 59,
  PLYEventPropertySessionDuration = 60,
  PLYEventPropertySessionCount = 61,
  PLYEventPropertyScreenDuration = 62,
  PLYEventPropertyScreenDisplayedAt = 63,
  PLYEventPropertyScreenDisplayedAtMs = 64,
  PLYEventPropertyAppInstalledAt = 65,
  PLYEventPropertyAppInstalledAtMs = 66,
};
