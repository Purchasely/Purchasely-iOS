...
- (UIViewController * _Nullable)viewControllerFor:(PLYPresentation * _Nonnull)presentation SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, strong) PLYPresentation * _Nullable presentation;
- (nonnull instancetype)initWithController:(UIViewController * _Nullable)controller contentId:(NSString * _Nullable)contentId presentation:(PLYPresentation * _Nullable)presentation;
...
///
/// \param transitionType An optional display mode override. When provided, the presentation will be shown using this transition instead of the backend-defined display mode.
///
...
/// \param connection The <code>PLYConnection</code> object representing the connection. If nil, will fall back to the presentation’s default connection.
///
...
@class NSURL;
enum PLYWebCheckoutProvider : NSInteger;
...
+ (void)startWithAPIKey:(NSString * _Nonnull)apiKey appUserId:(NSString * _Nullable)appUserId runningMode:(enum PLYRunningMode)runningMode storekitSettings:(StorekitSettings * _Nonnull)storekitSettings logLevel:(enum PLYLogLevel)logLevel initialized:(void (^ _Nullable)(BOOL, NSError * _Nullable))initialized;
...
///
+ (void)setShowPromotedInAppPurchasePaywall:(BOOL)enabled;
...
/// note:
/// Pass <code>nil</code> to use the backend-defined display mode (no override). From Objective-C, pass <code>nil</code> for no override or a <code>PLYDisplayMode</code> instance to override.
/// \param placementId The placementId identifying where the user is in your app
///
/// \param displayMode (optional) Display mode override. When provided, overrides the backend-defined display mode and sends the override to analytics. When <code>nil</code> (default), uses the backend-defined display mode.
///
/// \param completion Block called with the loaded presentation or an error
///
+ (void)displayFor:(NSString * _Nonnull)placementId displayMode:(PLYDisplayMode * _Nullable)displayMode completion:(void (^ _Nullable)(PLYPresentation * _Nullable, NSError * _Nullable))completion;
...
/// \param completion Block called with the loaded presentation or an error
///
+ (void)displayWith:(NSString * _Nullable)presentationVendorId displayMode:(PLYDisplayMode * _Nullable)displayMode completion:(void (^ _Nullable)(PLYPresentation * _Nullable, NSError * _Nullable))completion;
@end
